...
public class BlockTerraSapling extends BlockSapling {
    private IIcon[] icons;

    public BlockTerraSapling() {
        this.setBlockName("customSaplingterra");
        this.setBlockTextureName(TMElementCore.MODID +":custom_sapling_terra");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenTerraTree treeGen = new WorldGenTerraTree(true, 7, 5);
