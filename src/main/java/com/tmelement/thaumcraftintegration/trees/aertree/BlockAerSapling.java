...
public class BlockAerSapling extends BlockSapling {
    private IIcon[] icons;

    public BlockAerSapling() {
        this.setBlockName("customSaplingaer");
        this.setBlockTextureName(TMElementCore.MODID +":custom_sapling_aer");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenAerTree treeGen = new WorldGenAerTree(true, 7, 5);
