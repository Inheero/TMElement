...
public class BlockAerLog extends BlockLog {
    // Массив для хранения текстур
    private IIcon[] icons = new IIcon[3];

    public BlockAerLog() {
        super();
        this.setBlockName("custom_log_aer"); // Название блока
        this.setBlockTextureName(TMElementCore.MODID +":custom_log_aer"); // Путь к текстуре
    }
