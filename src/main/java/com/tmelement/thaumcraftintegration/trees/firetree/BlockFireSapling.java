...
public class BlockFireSapling extends BlockSapling {
    private IIcon[] icons;

    public BlockFireSapling() {
        this.setBlockName("customSapling");
        this.setBlockTextureName(TMElementCore.MODID +":custom_sapling");
    ...
    public void generateTree(World world, int x, int y, int z, Random rand) {
        ...
        WorldGenFireTree treeGen = new WorldGenFireTree(true, 7, 5);
